...
async def confirm_form(message: types.Message, state: FSMContext):
    ...
    edit_map = {
        ...
        "11 O'zbek tili":   (VacancyForm.english_level,   _lang_kb,                            "🇺🇿 O'zbek tili darajangizni tanlang:"),
...
async def sotuvchi_get_prev_experience(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "💼 <b>7/23</b> — Oldin qaysi sohada / qanday lavozimda ishlagansiz?\n"
